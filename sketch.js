...
var cars = [];
var blastImage;  
var upArrowKey_Img,downArrowKey,leftArrowKey,rightArrowKey                 //C42// SA
...
function preload() {
  ...
  upArrowKey_Img = loadImage("./assets/upArrowKey.png");
  downArrowKey = loadImage("./assets/downArrowKey.png");
  rightArrowKey = loadImage("./assets/rightArrowKey.png");
  leftArrowKey = loadImage("./assets/leftArrowKey.png")
