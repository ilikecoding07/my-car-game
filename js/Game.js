  ...
  play() {
    ...
    if (allPlayers !== undefined) {
      ...
      for (var plr in allPlayers) {
        ...
        // *************************************************************
    upArrowKey = createSprite(width / 2 + 360, height - 290)
    upArrowKey.addImage("control",upArrowKey_Img)
    upArrowKey.scale= 1.0

    downArrowKey = createSprite(width / 2 + 360, height - 140)
    downArrowKey.scale= 1.0

    leftArrowKey = createSprite(width / 2 - 540, height - 140)
    leftArrowKey.scale= 1.0

    rightArrowKey = createSprite(width / 2 - 390, height - 140)
    downArrowKey.scale= 1.0
